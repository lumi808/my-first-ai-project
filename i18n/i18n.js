    ...
    resources: {
      ...
      ru: {
        translation: {
          ...
          landing: {
            title: "Встречай своего ИИ Ассистента по Свиданиям",
            ...
            getstarted: {
              ...
              features: {
                first: "Просто сообщите о своих предпочтениях и укажите бюджет",
          ...
          chat: {
            firstmessage: "Привет! Я помощник на свиданиях. Расскажите мне о своих предпочтениях и предпочтениях вашего партнера. Также было бы полезно указать ваш бюджет и стадию отношений с вашим партнером.",
            examples: {
