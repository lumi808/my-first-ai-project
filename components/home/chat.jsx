    ...
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-b from-transparent via-white to-white flex flex-col items-center clear-both">
      ...
      <div className="mx-2 my-4 flex-1 flex items-center w-full md:mx-4 md:mb-[52px] lg:max-w-2xl xl:max-w-3xl">
        ...
        <motion.button 
          ...
          type="button" 
          onClick={() => pressReload()} 
          className="text-gray-500 bg-cyan-200 hover:bg-cyan-300 focus:ring-5 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 shadow-md">
