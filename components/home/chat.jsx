  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-b from-transparent via-white to-white flex flex-col items-center clear-both">
      {!showOptionButtons ? (<motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="mx-auto flex w-fit items-center gap-3 rounded-lg border border-neutral-200 bg-cyan-50 py-2 px-4 text-black text-sm hover:opacity-50 disabled:opacity-25 shadow-md"
      ...
      <div className="mx-2 my-4 flex-1 flex items-center w-full md:mx-4 md:mb-[52px] lg:max-w-2xl xl:max-w-3xl">
        <div className="relative mx-2 flex-1 flex-col rounded-lg border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)] sm:mx-4">
          ...
          <motion.button
            ...
            className={cx(
              ...
              inputActive && "bg-cyan-200 hover:bg-cyan-300 hover:text-gray-900",
              "absolute right-2 top-2 rounded-md p-1 text-neutral-800 opacity-60 hover:bg-cyan-300 hover:text-neutral-900 transition-colors")}
            type="submit"
            onClick={() => {
              sendMessage(input)
              setInput('')
          ...
          >
            {shouldShowLoadingIcon
              ? <div className="h-6 w-6 animate-spin rounded-full border-t-2 border-neutral-800 opacity-60"></div>
              : <div className={cx(inputActive && "text-gray-900", "w-6 h-6")}>
                <PaperAirplaneIcon />
              </div>
            }
          </motion.button>
        ...
        <motion.button 
          ...
          type="button" 
          onClick={() => pressReload()} 
          className="text-gray-500 bg-cyan-200 hover:bg-cyan-300 focus:ring-5 focus:outline-none focus:ring-gray-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2 shadow-md">
  ...
  return (
    <div className="flex-1 flex justify-center w-screen border-zinc-100 overflow-hidden">
      <div
        ...
        // need to change
        className="md:w-7/12 max-h-[calc(100vh-4rem)]  justify-center overflow-x-hidden w-11/12"
