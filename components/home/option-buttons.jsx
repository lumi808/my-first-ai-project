    ...
    return (
        responseGenerating?(
            <div className="flex justify-center">
                <button disabled type="button" className="py-2.5 px-5 mr-2 text-sm font-medium text-gray-900 bg-cyan-50 rounded-lg border border-gray-200 hover:bg-cyan-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:outline-none focus:ring-cyan-200 focus:text-cyan-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center shadow-md">
            ...
            <div className="flex justify-center">
                <motion.button 
                    ...
                    className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-cyan-50 rounded-lg border border-gray-200 hover:bg-cyan-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 shadow-md"
                    >Option 1
                </motion.button>
